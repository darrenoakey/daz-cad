...
class TestLibraryExportTester(unittest.TestCase):
    ...
    def test_perform_export_test(self):
        ...
        # Test with None object (export functions handle this gracefully with placeholder data)
        success, error = tester.perform_export_test(None, 'shape', 'stl', 'test_key')
        # The export should succeed because export functions return placeholder data for None
